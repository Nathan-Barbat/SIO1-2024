    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h3 class="card-title mb-0">Modifier le quiz</h3>
            </div>
            <div class="card-body">
                <form action="index.php?controller=quiz&action=update" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="titre" name="titre" value="<?php echo $quiz['titre_quiz']; ?>" required>
                    </div>
                                            ...
                                            <td>
                                                <div class="form-check">
                                                    <input class="form-check-input question-checkbox" type="checkbox" name="questions[]" value="<?php echo $question['id_question']; ?>"
                                                        <?php echo in_array($question['id_question'], $selectedQuestions) ? 'checked' : ''; ?>>
                                                </div>
                                            </td>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                        <a href="index.php?controller=quiz&action=view&id=<?php echo $quiz['id_quiz']; ?>" class="btn btn-outline-secondary me-md-2">Annuler</a>
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p><strong>Nombre de questions actuel :</strong> <?php echo count($quiz['questions']); ?></p>
                
                <hr>
                
                <div class="alert alert-warning">
                    <i class="fas fa-exclamation-triangle"></i> La modification du quiz n'affectera pas les scores déjà enregistrés.
                </div>
            </div>
        </div>
